...
namespace InfinityCode.OnlineMapsDemos
{
    ...
    public class DriveUsingGPS : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            CamMarker = OnlineMapsMarker3DManager.CreateItem(lng, lat, prefab);
        }
        ...
        private void Update()
        {
            ...
            lat = mqttManager.latitude;
            lng = mqttManager.longitude;
            marker.rotationY = mqttManager.rotation;
            marker.SetPosition(lng, lat);
            CamMarker.SetPosition(lng, lat);
